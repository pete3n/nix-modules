  ...
  batmond =
    pkgs.writeShellScriptBin "batmond" # sh
      ''
        ...
        # without this daemon observing it means it was charged while powered off, 
        # or state left over from a previous discharge cycle. The stored value 
        # would suppress every threshold: after a shutdown at 1%, `bat_last_cap > 
        # SUSPEND_PERCENT` stays false forever.
